...
- The architecture gate rejects missing flag values and malformed rule-set
  ...
  `--root` value, absent legacy paths, and non-array rule-set paths.
...
- Rust 1.92.0 and current-stable full workspace tests pass. Raw evidence is
  `/tmp/agent-hooks-rs-pr12-final-tests.txt` at SHA-256
  `f678e4e3237da22396fdc8b5a8f9fe9696216b21f32fb6ce7de37dde64eb4cb9`
  and `/tmp/agent-hooks-rs-pr12-final-current-tests.txt` at SHA-256
  `5064d3ecbf8da0f6473a5076235002314e32a70a2072c9b1355c7027fe242084`.
